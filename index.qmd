...
I have just started. Currently I am working on Chapter 1 "About successful {**shiny**} Apps".
...
[Engineering Production-Grade Shiny Apps](https://engineering-shiny.org/) by Colin Fay, Sébastien Rochette, Vincent Guyader and Cervan Girard. [@fay-2021a].

I have some rudimentary {**shiny**} knowledge, but not sufficient enough for my big project of a dashboard for [Reporters Without Borders](https://rsf.org/en/index) data. "Engineering Production-Grade Shiny Apps" promises to fill my knowledge gap. See the following paragraph from the "Welcome" page:
...
My text consists mainly of quotes from the "Engineering" book. Sometimes I have them changed slightly to fit the flow of my notes better. But I have not referenced the position of the (semi)quotes in the book. As I generally follow the book's outline using the structure for headers, it should be clear where to find the quotes. 
...
If you fork the [enginnering-shiny](https://bookdown.org/pbaumgartner/engineering-shiny/) then the glossary will not
